...
<style>
    ...
    .inbox-unread { display: inline-flex; align-items: center; gap: 9px; min-height: 40px; padding: 0 14px; border: 1px solid #ead8c7; border-radius: 999px; background: #fff; color: #6d4c5b; font-size: 12px; font-weight: 800; box-shadow: 0 10px 28px rgba(52,35,43,.06); }
    .inbox-unread-dot { width: 8px; height: 8px; border-radius: 50%; background: #b94b4b; box-shadow: 0 0 0 5px rgba(185,75,75,.1); }

    .inbox-toolbar { overflow: hidden; margin-bottom: 18px; border: 1px solid #ead8c7; border-radius: 15px; background: #fff; box-shadow: 0 18px 45px rgba(52,35,43,.06); }
    ...
    .inbox-tab:hover { background: #fff; color: #6d4c5b; }
    .inbox-tab.active { background: #6d4c5b; color: #fff; box-shadow: 0 8px 18px rgba(109,76,91,.18); }
    ...
    .inbox-tab.active .inbox-tab-count { background: rgba(255,255,255,.16); }
    ...
    .inbox-item { position: relative; display: grid; grid-template-columns: auto minmax(0,1fr) auto; gap: 15px; align-items: center; overflow: hidden; border: 1px solid #ead8c7; border-radius: 14px; background: #fff; padding: 17px 18px 17px 21px; box-shadow: 0 10px 28px rgba(52,35,43,.045); transition: transform .15s ease, border-color .15s ease, box-shadow .15s ease; }
    .inbox-item:hover { transform: translateY(-1px); border-color: #d8c1b1; box-shadow: 0 16px 34px rgba(52,35,43,.08); }
    .inbox-item.unread { background: linear-gradient(90deg, color-mix(in srgb, var(--type-color) 7%, white), #fff 38%); }
    ...
    .inbox-new { display: inline-flex; height: 18px; align-items: center; border-radius: 999px; padding: 0 7px; color: #fff; background: var(--type-color); font-size: 8px; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; }
    ...
    .inbox-action { display: inline-flex; min-height: 34px; align-items: center; gap: 7px; border: 1px solid color-mix(in srgb, var(--type-color) 28%, white); border-radius: 9px; padding: 0 11px; color: var(--type-color); background: #fff; font-size: 10px; font-weight: 800; text-decoration: none; white-space: nowrap; transition: color .15s ease, background .15s ease; }
    .inbox-action:hover { color: #fff; background: var(--type-color); }
    ...
    .inbox-empty-icon { display: inline-flex; width: 54px; height: 54px; align-items: center; justify-content: center; border-radius: 17px; background: #fff; color: #9b7d89; box-shadow: 0 10px 25px rgba(52,35,43,.06); }
