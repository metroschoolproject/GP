...
<style>
    ...
    .log-page { max-width: 1440px; margin: 0 auto; color: #6d4c5b; }
    ...
    .log-title { margin: 0; font-family: "Playfair Display", serif; font-size: clamp(30px, 3vw, 42px); font-weight: 650; line-height: 1; color: #6d4c5b; }
    .log-subtitle { max-width: 620px; margin: 10px 0 0; color: #7b5c69; font-size: 13px; line-height: 1.6; }
    .log-export { display: inline-flex; align-items: center; gap: 9px; min-height: 42px; padding: 0 16px; border: 1px solid #6d4c5b; border-radius: 11px; background: #6d4c5b; color: #FFFFFF; font-size: 12px; font-weight: 700; text-decoration: none; box-shadow: 0 10px 22px rgba(109,76,91,.18); transition: transform .16s ease, box-shadow .16s ease; }
    ...
    .log-stats { display: grid; grid-template-columns: repeat(4, minmax(0,1fr)); margin-bottom: 18px; overflow: hidden; border: 1px solid #ead8c7; border-radius: 15px; background: #FFFFFF; box-shadow: 0 18px 45px rgba(52,35,43,.06); }
    ...
    .log-stat-value { display: block; margin-top: 8px; color: #6d4c5b; font-family: 'DM Sans', sans-serif; font-size: 28px; font-weight: 750; line-height: 1; font-variant-numeric: tabular-nums; letter-spacing: -.025em; }
    .log-stat-note { display: block; margin-top: 7px; color: #a58b96; font-size: 11px; }

    .log-panel { overflow: hidden; border: 1px solid #ead8c7; border-radius: 15px; background: #FFFFFF; box-shadow: 0 18px 45px rgba(52,35,43,.06); }
    .log-filters { display: grid; grid-template-columns: minmax(240px, 1.6fr) repeat(4, minmax(135px, .7fr)) auto; gap: 10px; padding: 16px; border-bottom: 1px solid #ead8c7; background: #FFFFFF; }
    ...
    .log-control { width: 100%; min-height: 42px; box-sizing: border-box; border: 1px solid #e4d2c3; border-radius: 10px; background: #FFFFFF; padding: 0 12px; color: #6d4c5b; font: 500 12px Inter, sans-serif; }
    ...
    .log-apply { border: 1px solid #6d4c5b; background: #6d4c5b; color: #FFFFFF; }
    .log-reset { border: 1px solid #e4d2c3; background: #FFFFFF; color: #7b5c69; text-decoration: none; }

    .log-table-wrap { overflow-x: auto; }
    .log-table { width: 100%; min-width: 940px; border-collapse: collapse; }
    .log-table th { padding: 13px 18px; border-bottom: 1px solid #ead8c7; background: #FFFFFF; color: #9b7d89; font-size: 9px; font-weight: 800; letter-spacing: .13em; text-align: left; text-transform: uppercase; }
    ...
    .log-time { color: #6d4c5b; font-weight: 700; white-space: nowrap; }
    ...
    .log-event-name { color: #6d4c5b; font-weight: 700; }
    ...
    .log-user { color: #6d4c5b; font-weight: 700; }
    ...
    .log-empty h2 { margin: 15px 0 6px; color: #6d4c5b; font: 700 17px Inter, sans-serif; }
    ...
    .log-drawer-title { margin: 0; color: #6d4c5b; font: 700 21px "Playfair Display", serif; }
