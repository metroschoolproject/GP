...
<style>
    ...
    .ps-page { max-width: 860px; margin: 0 auto; color: #34232b; }
    .ps-kicker { margin: 0 0 7px; color: #9b7d89; font-size: 10px; font-weight: 800; letter-spacing: .18em; text-transform: uppercase; }
    .ps-title { margin: 0; font-family: "Playfair Display", serif; font-size: clamp(28px, 3vw, 40px); font-weight: 650; line-height: 1; color: #34232b; }
    .ps-subtitle { max-width: 560px; margin: 10px 0 0; color: #7b5c69; font-size: 13px; line-height: 1.6; }

    .ps-card { margin-top: 28px; border: 1px solid #ead8c7; border-radius: 15px; background: #fcf8f5; box-shadow: 0 18px 45px rgba(52,35,43,.06); overflow: hidden; }
    .ps-card-header { padding: 22px 28px; border-bottom: 1px solid #ead8c7; }
    .ps-card-title { margin: 0; font-size: 16px; font-weight: 700; color: #34232b; }
    ...
    .ps-label { display: block; margin-bottom: 8px; font-size: 12px; font-weight: 700; color: #34232b; text-transform: uppercase; letter-spacing: .08em; }
    .ps-input-wrap { position: relative; max-width: 200px; }
    .ps-input { width: 100%; padding: 10px 40px 10px 14px; border: 1px solid #ead8c7; border-radius: 10px; background: #fff; font-size: 16px; font-weight: 600; color: #34232b; transition: border-color .15s, box-shadow .15s; -moz-appearance: textfield; }
    ...
    .ps-preview-row { display: flex; justify-content: space-between; align-items: center; padding: 6px 0; font-size: 13px; color: #34232b; }
    ...
    .ps-btn-primary { background: #6d4c5b; color: #fcf8f5; box-shadow: 0 10px 22px rgba(109,76,91,.18); }
    ...
    .ps-info-card-value { margin-top: 6px; font-size: 20px; font-weight: 750; color: #34232b; font-variant-numeric: tabular-nums; }
