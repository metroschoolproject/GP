...
<style>
  *{box-sizing:border-box}
  body{margin:0;font-family:'DM Sans',system-ui,-apple-system,sans-serif;background:#fbeee0;color:#111827;padding:40px 16px}
  .wrap{max-width:1120px;margin:0 auto}
  .payment-layout{display:grid;grid-template-columns:minmax(0,1fr) 380px;gap:22px;align-items:start;margin-top:18px}
  .payment-main,.payment-side{min-width:0}
  .payment-side{position:sticky;top:28px}
  ...
  .card{background:#fcf8f5;border:1px solid rgba(184,146,74,.38);border-radius:20px;padding:0;margin-top:0;margin-bottom:18px;overflow:hidden;box-shadow:0 20px 60px rgba(26,17,24,.08)}
  .card-label{font-family:'DM Sans',system-ui,-apple-system,sans-serif;font-size:10px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#b79c8b;padding:20px 24px;border-bottom:1px solid #f0e6da;margin-bottom:0}
  ...
  .context-banner{background:#fffdf4;border:1px solid rgba(184,146,74,.42);border-radius:10px;padding:12px 14px;margin-bottom:12px;font-size:13px;color:#7a5c35;line-height:1.5}
  ...
  .transfer-amount-field{padding:12px;border:1px solid rgba(22,101,52,.18);border-radius:12px;background:#f0fdf4}
  ...
  @media(max-width:760px){.payment-layout{grid-template-columns:1fr}.payment-side{position:static;order:-1}.grid2{grid-template-columns:1fr}}
</style>
</head>
<body>
<div class="wrap">
  ...
  <div class="payment-layout">
    <div class="payment-main">
      ...
      <form action="<?= URLROOT ?>/booking/rejectReplacement/<?= $replacementId ?>" method="post"
        ...
        <?= csrf_field() ?>
        <button type="submit" class="btn" style="background:#fff;color:#991b1b;border:1px solid #fecaca;margin-top:0">
