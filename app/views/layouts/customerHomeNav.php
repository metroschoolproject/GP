...
.nav-partner,.nav-login{display:inline-flex;align-items:center;justify-content:center;min-height:31px;border-radius:7px;font-size:12px;font-weight:800;text-decoration:none;transition:all .2s ease}
.nav-partner{padding:5px 12px;background:#3f241a;color:#fff8ef;box-shadow:none}
.nav-partner:hover{transform:translateY(-1px);background:#4a2d22;color:#fff8ef}
.nav-login{padding:5px 11px;background:#fff8ef;color:#3f2f24}
...
.home-profile-menu-item{display:flex;align-items:center;gap:10px;padding:6px 5px;border-radius:8px;color:#4f454b;font-size:10px;font-weight:600;text-decoration:none;transition:all .15s}
