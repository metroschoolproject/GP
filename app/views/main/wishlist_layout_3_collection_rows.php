...
<style>
:root{
  --c-bg:#f5e8d9;--c-white:#fff;--c-rule:#ead8c7;--c-strong:#765a46;--c-accent:#6f625a;--c-muted:#9b7d6b;
...
.wl-hbtn--primary{background:var(--c-strong);color:#fff;box-shadow:0 8px 24px rgba(118,90,70,.18)}
